...
object PamfletUrl {
  ...
  val redirect = Map[PamfletPage, HtmlSectionName](
    ...
    "Developing using Eclipse.html" -> "#_developing_using_eclipse",
    "Viewing the lift_proto H2 database.html" -> "#_viewing_the_lift_proto_h2_database",
    "Using the latest Lift build.html" -> "#_using_the_latest_lift_build",
    ...
    "Running code when sessions are created (or destroyed).html" -> "#_running_code_when_sessions_are_created_or_destroyed",
    "Run code when Lift shutsdown.html" -> "#_run_code_when_lift_shuts_down",
    "Running stateless.html" -> "#_running_stateless",
